...
export function ZoomIn({ state = 'default', className = '' }: IconProps) {
  ...
  return (
    ...
    >
      ...
      <line x1="12" y1="8" x2="12" y2="16" stroke={strokeColor} strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
