...
export function DownloadGeoJSON({ state = 'default', className = '' }: IconProps) {
  ...
  return (
    ...
    >
      ...
      <polyline points="12,5 12,15" stroke={strokeColor} strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
      <polyline points="8,11 12,15 16,11" stroke={strokeColor} strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
